...
const Hero = () => {
  return (
    <div className="flex xl:flex-row flex-col gap-2 h-fit mt-40 relative w-[100%] mx-auto">
      ...
      <div className="xl:flex-[1] flex justify-end items-center w-full max-lg:pb-8">
        <div className="relative xl:w-full w-[90%] xl:h-full z-10 h-[500px] max-md:h-[300px]">
          <Image src={person} alt="Person One" width={700} height={700} className="object-contain -mt-28 rounded-full" />
        </div>
