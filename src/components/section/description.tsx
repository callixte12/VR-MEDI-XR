...
const CompanyDescription = () => {
  ...
  return (
    <motion.div className="relative mt-24 max-lg:mt-[250px] z-20 xxl:py-8" variants={fadeIn("right", "spring", 0.5, 0.75)}>
        <div className="z-10 bg-white lg:flex-col h-fit min-h-[450px] max-md:h-[900px] max-sm:gap-8 sm:px-12 px-6 max-w-[1800px] mx-auto">
            <div className="flex max-lg:flex-col gap-4 items-center justify-center lg:px-20">
                ...
                <div className="description__accordion flex-1 lg:pl-12 w-[100%]">
                    <Accordion />
                </div>
            </div>
        </div>
