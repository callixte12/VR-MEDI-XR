...
const Footer = () => {
  return (
    ...
    >
        ...
        <div className="mx-6 py-10 text-center md:text-left">
            <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-5">
                <div className="col-span-2">
                    ...
                    <p>
                        Changing the future of healthcare with advanced simulation and Augmented Reality
                    </p>
                </div>
                <div className="">
                    ...
                    <p className="mb-4">
                        <a href="#!" className="text-neutral-600 dark:text-neutral-200">Resources</a>
                    </p>
                    <p>
                        <a href="#!" className="text-neutral-600 dark:text-neutral-200">FAQs</a>
                    </p>
                </div>
                <div className="">
                    <h6 className="mb-4 flex justify-center font-semibold uppercase md:justify-start">
                    ...
                    <p className="mb-4">
                        <a href="#!" className="text-neutral-600 dark:text-neutral-200">Simulation</a>
                    </p>
                    <p className="mb-4">
                        <a href="#!" className="text-neutral-600 dark:text-neutral-200">Free plan</a>
                    </p>
                    <p className="mb-4">
                ...
                <div>
                    ...
                    <p className="mb-4 flex items-center justify-center md:justify-start">
                        ...
                        3rd Floor, Sanlam Towers <br /> 10KN 67 St, Kigali
                    </p>
                    <p className="mb-4 flex items-center justify-center md:justify-start">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="bg-primary flex text-left items-center justify-between border-b-1 border-neutral-500 p-6 lg:justify-between">
            <div className="">
                <span>© 2024 Copyright - </span>
                <a
                    className="font-semibold text-dimWhite"
            ...
            <div className="flex gap-4">
                <Link href="#" className="border-r pr-4 border-1 border-dimWhite">Terms & Policy</Link>
